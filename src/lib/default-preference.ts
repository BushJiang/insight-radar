...
export const defaultRecommendationAgentPrompt = `请根据领域偏好{{domainPreferences}}和用户需求{{query}}，为项目{{projectFullName}}写推荐说明。项目简介：{{readmeSummary}}，语言：{{projectLanguage}}，成熟度：{{maturity}}，Stars：{{stars}}，来源：{{sourceGithubUsername}}。`
// 🔰 项目简介生成的默认提示词模板
